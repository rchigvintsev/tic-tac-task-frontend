...
import {TasksFromListComponent} from './tasks-from-list.component';
...
describe('TasksFromListComponent', () => {
  const taskList = new TaskList().deserialize({id: 1, name: 'Test task list'});

  let component: TasksFromListComponent;
  let fixture: ComponentFixture<TasksFromListComponent>;
  let router: Router;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TasksFromListComponent);
