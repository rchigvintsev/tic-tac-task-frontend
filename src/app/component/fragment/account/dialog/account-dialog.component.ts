...
import {AccountPasswordChangeComponent, PasswordChangeEvent} from '../password/change/account-password-change.component';
...
export class AccountDialogComponent implements OnInit {
  ...
  changePasswordComponent: AccountPasswordChangeComponent;
