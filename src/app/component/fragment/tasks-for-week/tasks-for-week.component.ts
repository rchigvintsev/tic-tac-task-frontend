...
@Component({
  selector: 'app-tasks-for-week',
  templateUrl: './tasks-for-week.component.html',
  styleUrls: ['./tasks-for-week.component.scss']
})
export class TasksForWeekComponent implements OnInit, OnDestroy {
  @Input()
  loading: boolean;
  ...
  private createTaskGroup(i: number, dayNumber: number): TaskGroup {
    ...
    return new TaskGroup(TasksForWeekComponent.getTaskGroupName(i, dayNumber), taskRequest, this.taskService);
  }
