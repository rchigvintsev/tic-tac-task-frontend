...
@Component({
  selector: 'app-sidenav-task-lists',
  templateUrl: './sidenav-task-lists.component.html',
  styleUrls: ['./sidenav-task-lists.component.scss']
})
export class SidenavTaskListsComponent implements OnInit, OnDestroy {
